...
public class Picture {
	...
	public static Picture fromFile(File file) {
		...
		Picture picture = new Picture(data.getString("Name"), data.getString("Author"),
				Size.getFromSize(data.getInteger("Resolution")));
		picture.source = file;
	...
	public static enum Size {
		X16(16, 16, 8, 8), X32(32, 32, 4, 4), X1408(608, 608, 1, 1);

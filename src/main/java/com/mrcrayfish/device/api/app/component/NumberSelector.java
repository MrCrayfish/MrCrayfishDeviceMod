...
public class NumberSelector extends Component {
	...
	/**
	 * Sets the minimum value a user can select. Throws an illegal argument
	 * exception if the value is less than 0 or more than the max value.
	 *
	 * @param min
	 *            the minimum value
	 */
	public void setMin(int min) {
		if ((min < 0) || (min > max)) {
			throw new IllegalArgumentException(
					"The min value must be more or equal to zero and less than or equal to the max value");
		}
	...
	/**
	 * Sets the maximum value a user can select. Throws an illegal argument
	 * exception if the value is less than 0 or less than the min value.
	 *
	 * @param max
	 *            the maximum value
	 */
	public void setMax(int max) {
		if ((max < 0) || (max < min)) {
			throw new IllegalArgumentException(
					"The max value must be more or equal to zero and more than or equal to the min value");
		}
	...
	/**
	 * Sets the current number selection. Throws an illegal argument exception if
	 * the value is not within the bounds of the min and max value.
	 *
	 * @param current

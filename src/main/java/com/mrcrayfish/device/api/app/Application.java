...
public abstract class Application extends Wrappable {
	 ...
	 * {@link com.mrcrayfish.device.api.app.Layout#addComponent(Component)} instead.
	 *
	 * @param c
	 ...
	 * <p>
	 * The parameters passed are the x and y location of the top left corner or your
	 * application window.
	 */
	@Override
	...
	/**
	 * Called when you scroll the wheel on your mouse. Note if you override, make
	...
	/**
	 * Called when you first load up your application. Allows you to read any stored
	 * data you have saved. Only called if you have saved data. This method is
	 * called after {{@link #init()} so you can update any Components with this
	 * data.
	 *
	 * @param tagCompound
	 ...
	 * {@link #isDirty()} returns true. You can mark your application as dirty by
	 * calling {@link #markDirty()}.
	 *
	 * @param tagCompound
	...
	/**
	 * Sets the defaults layout height. It should be noted that the height must be
	 * within 20 to 164.
	 *
	 * @param height
	 *            the height
	...
	/**
	 * Marks that data in this application has changed and needs to be saved. You
	 * must call this otherwise your data wont be saved!
	 */
	...
	/**
	 * Gets the text in the title bar of the application. You can change the text by
	 * setting a custom title for your layout. See {@link Layout#setTitle}.
	 *
	...
	/**
	 * Determines how a file is handled when it's opened with this application. By
	 * default, this method returns true, however returning false indicates that the
	 * file could not be opened and will prompt the user with a dialog.
	 *
	 * @param file
	...
	/**
	 * Check if an application is equal to another. Checking the ID is sufficient as
	...
	public boolean equals(Object obj) {
		...
		return app.info.getFormattedId().equals(info.getFormattedId());
	}
}

...
public abstract class Application extends Wrappable
{
	...
	/**
	 * Adds a component to the default layout. Don't get this confused with your custom layout. You should use {@link com.mrcrayfish.device.api.app.Layout#addComponent(Component)} instead.
	 *
	 * @param c
	...
	/**
	 * Called when you press a mouse button. Note if you override, make sure you call this super method.
	 *
	 * @param mouseX
	...
	/**
	 * Called when you drag the mouse with a button pressed down Note if you override, make sure you call this super method.
	 *
	 * @param mouseX
	 *            the current x position of the mouse
	 * @param mouseY
	...
	/**
	 * Called when you release the currently pressed mouse button. Note if you override, make sure you call this super method.
	 *
	 * @param mouseX
	...
	/**
	 * Called when you scroll the wheel on your mouse. Note if you override, make sure you call this super method.
	 *
	 * @param mouseX
	...
	/**
	 * Called when a key is released on your keyboard. Note if you override, make sure you call this super method.
	 *
	 * @param character
	...
	/**
	 * Updates the components of the current layout to adjust to new window position. There is really be no reason to call this method.
	 *
	 * @param x
	 * @param y
	 */
	...
	/**
	 * Called when you first load up your application. Allows you to read any stored data you have saved. Only called if you have saved data. This method is called after {{@link Wrappable#init(NBTTagCompound)} so you can update any Components with this data.
	 *
	 * @param tagCompound
	...
	/**
	 * Sets the defaults layout width. It should be noted that the width must be within 20 to 362.
	 *
	 * @param width
	 *            the width
	 */
	...
	/**
	 * Sets the defaults layout height. It should be noted that the height must be within 20 to 164.
	 *
	 * @param height
	 *            the height
	 */
	...
	/**
	 * Marks that data in this application has changed and needs to be saved. You must call this otherwise your data wont be saved!
	 */
	...
	/**
	 * Determines how a file is handled when it's opened with this application. By default, this method returns true, however returning false indicates that the file could not be opened and will prompt the user with a dialog.
	 *
	 * @param file
	 *            the file attempting to be opened
	 */
	...
	/**
	 * Check if an application is equal to another. Checking the ID is sufficient as they should be unique.
	 */
	@Override

...
public abstract class Component extends Gui {
	 ...
	 * <p>
	 * Laying out components is simply relative positioning. So for left (x
	 * position), specific how many pixels from the left of the application window
	 * you want it to be positioned at. The top is the same, but instead from the
	 * top (y position).
	 *
	 * @param left
	...
	/**
	 * Called when this component is added to a Layout. You can add sub-components
	 * through this method. Use {@link Layout#addComponent(Component)}
	 * 
	 * @param layout
	 */
	...
	/**
	 * Called when the Layout this component is bound to is set as the current
	 * layout in an application.
	 */
	...
	/**
	 * Called when you mouse button has been pressed. You have to do your own
	 * checking to test if it was within the component's bounds.
	 *
	 * @param mouseX
	 *            the current x position of the mouse
	 * @param mouseY
	 ...
	 * your own checking to test if it was within the component's bounds.
	 *
	 * @param mouseX
	...
	/**
	 * This method should be ignored. Used for the core. Will probably be removed in
	 * the future.
	 */
	...
	/**
	 * Sets whether this component is enabled. You should respect this value if you
	 * create your own custom components.
	 *
	 * @param enabled
	 *            if this component should be enabled or not
	 */
	...
	/**
	 * Sets whether this component is visible. You should respect this value if you
	 * create your own custom components.
	 *
	 * @param visible
	 *            if this component should be visible or not
	 */

...
/**
 * The Layout class is the main implementation for displaying components in your
 * application. You can have multiple layouts in your application to switch
 * interfaces during runtime.
 * <p>
 * Use
 * {@link com.mrcrayfish.device.api.app.Application#setCurrentLayout(Layout)}
 * inside of {@link com.mrcrayfish.device.api.app.Application#init()} to set the
 * current layout for your application.
 * <p>
 * Check out the example applications to get a better understand of how this
 * works.
 *
 * @author MrCrayfish
 */
public class Layout extends Component {
	...
	/**
	 * Default constructor. Initializes a layout with a width of 200 and a height of
	 * 100. Use the alternate constructor to set a custom width and height.
	 */
	public Layout() {
		this(200, 100);
	}
	...
	/**
	 * Constructor to set a custom width and height. It should be noted that the
	 * width must be in the range of 20 to 362 and the height 20 to 164.
	 *
	 * @param width
	 * @param height
	 */
	 ...
	 * {@link Application#setCurrentLayout(Layout)}. Will trigger on initialization
	 * listener if set. See {@link #setInitListener(InitListener)}
	 */
	public void init() {
	...
	/**
	 * Renders the background of this layout if a {@link Background} has be set. See
	 ...
	 * @param x
	 *            the starting x rendering position (left most)
	 * @param y
	 *            the starting y rendering position (top most)
	 */
	@Override
	...
	/**
	 * Sets the initialization listener for this layout. See {@link InitListener}.
	 *
	 * @param initListener
	 */
	...
	/**
	 * Sets the background for this layout. See {@link Background}.
	 *
	 * @param background
	 *            the background
	 */
	...
	public interface Background {
		 ...
		 *            the height of the layout
		 */
		void render(Gui gui, Minecraft mc, int x, int y, int width, int height, int mouseX, int mouseY,

...
public class ButtonToggle extends Button implements RadioGroup.Item {
	 ...
	 *            how many pixels from the top
	 */
	public ButtonToggle(int left, int top, ResourceLocation iconResource, int iconU, int iconV, int iconWidth,
			int iconHeight) {
	 ...
	 *            how many pixels from the top
	 */
	public ButtonToggle(int left, int top, String text, ResourceLocation iconResource, int iconU, int iconV,

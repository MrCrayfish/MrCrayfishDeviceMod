...
public class Slider extends Component {
	...
	public void render(Laptop laptop, Minecraft mc, int x, int y, int mouseX, int mouseY, boolean windowActive,
		...
		if (visible) {
			...
			drawRect(xPosition + newSliderX + 1, yPosition + 1, xPosition + newSliderX + 7, yPosition + 11,
					sliderColour);
		}
	}
	...
	public void handleMouseClick(int mouseX, int mouseY, int mouseButton) {
		...
		if (GuiHelper.isMouseInside(mouseX, mouseY, xPosition + newSliderX, yPosition, xPosition + newSliderX + 8,
				yPosition + 12)) {
			dragging = true;
			clickX = mouseX;
	...
	public void handleMouseDrag(int mouseX, int mouseY, int mouseButton) {
		...
		if (dragging) {
			newSliderX = prevSliderX + (mouseX - clickX);
			if (newSliderX < 0) {
				newSliderX = 0;
			}
	...
	public float getPercentage() {
		return (float) newSliderX / (float) (width - 8);
	}
	...
	public void setPercentage(float percentage) {
		...
		newSliderX = (int) ((width - 8) * percentage);
	}

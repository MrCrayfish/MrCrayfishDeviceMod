 ...
 * You should definitely use this instead of writing your own as this would
 * allow people to use the same currency across applications, not just your own.
 * </p>
 *
 * <p>
 * Please keep in mind that 1 unit equals 1 emerald. Players can withdraw
 * currency from their account into emeralds. Be nice, and don't abuse this
 * system. Check out the example applications to learn how you use this currency
 * system.
 * </p>
 *
 * @author MrCrayfish
...
public class BankUtil {
	 ...
	 * the balance, you need to implement a
	 * {@link com.mrcrayfish.device.api.task.Callback} and get the integer with the
	 * key "balance" from the NBT parameter.
	 *
	 * @param callback
	 *            he callback object to processing the response
	 */
	...
	/**
	 * <p>
	 * Sends a request for the user to pay x amount from their account. Use the
	 * callback to check if payment was successful. You will also get returned their
	 * new balance. Use the key "balance" to an integer from the NBT parameter in
	 * callback.
	 * </p>
	 *
	 * @param uuid
	 *            the UUID of the player you want to pay
	 * @param amount
	 *            the amount to pay
	 * @param callback
	 *            the callback object to processing the response
	 */
	...
	/**
	 * <p>
	 * Sends a request to add x amount to the user's account. Use the callback to
	 * check if addition was successful. You will also get returned their new
	 * balance. Use the key "balance" to an integer from the NBT parameter in
	 * callback.
	 * </p>
	 *
	 * @param callback
	...
	/**
	 * <p>
	 * Sends a request to remove x amount to the user's account. Use the callback to
	 * check if removal was successful. You will also get returned their new
	 * balance. Use the key "balance" to an integer from the NBT parameter in
	 * callback.
	 * </p>
	 *

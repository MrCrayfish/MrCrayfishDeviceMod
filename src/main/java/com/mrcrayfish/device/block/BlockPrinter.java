...
public class BlockPrinter extends BlockHorizontal implements ITileEntityProvider {
	private static final Bounds BODY_BOUNDS = new Bounds(5 * 0.0625, 0.0, 1 * 0.0625, 14 * 0.0625, 5 * 0.0625,
			15 * 0.0625);
	...
	private static final AxisAlignedBB[] BODY_BOUNDING_BOX = { BODY_BOX_SOUTH, BODY_BOX_WEST, BODY_BOX_NORTH,
			BODY_BOX_EAST };

	private static final Bounds TRAY_BOUNDS = new Bounds(0.5 * 0.0625, 0.0, 3.5 * 0.0625, 5 * 0.0625, 1 * 0.0625,
			12.5 * 0.0625);
	...
	private static final AxisAlignedBB[] TRAY_BOUNDING_BOX = { TRAY_BOX_SOUTH, TRAY_BOX_WEST, TRAY_BOX_NORTH,
			TRAY_BOX_EAST };
	...
	private static final AxisAlignedBB[] PAPER_BOUNDING_BOX = { PAPER_BOX_SOUTH, PAPER_BOX_WEST, PAPER_BOX_NORTH,
			PAPER_BOX_EAST };

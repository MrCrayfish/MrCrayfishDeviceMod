...
public class TaskBar {
	...
	public void render(Laptop gui, Minecraft mc, int x, int y, int mouseX, int mouseY, float partialTicks)
	{
		...
		if (isMouseInside(mouseX, mouseY, x + 332, y + 2, x + 332 + 30, y + 16))
		{
			Gui.drawRect(x + 332, y + 2, x + 332 + 30, y + 16, new Color(1.0F, 1.0F, 1.0F, 0.1F).getRGB());
		}
	...
	public void handleClick(Laptop laptop, int x, int y, int mouseX, int mouseY, int mouseButton)
	{
		...
		if (isMouseInside(mouseX, mouseY, x + 332, y + 2, x + 332 + 30, y + 16))
		{
			...
			Laptop.getSystem().openContext(layout, mouseX - layout.width, mouseY - layout.height);
		}
	}
